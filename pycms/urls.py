...
urlpatterns = patterns('',
                       ...
                       url(r'^ueditor_fileup/$',
                           'pycms.views.ueditor_file_up'),
                       url(r'^ueditor_scrawlup/$',
                           'pycms.views.ueditor_scraw_up'),
                       # modifiedurl
                       url(r'^ueditor_getRemoteImage/$',
                           'pycms.views.ueditor_getRemoteImage'),
                       url(r'^ueditor_getMovie/$',
                           'pycms.views.ueditor_getMovie'),
                       url(r'^ueditor_imageManager/$',
                           'pycms.views.ueditor_imageManager'),
